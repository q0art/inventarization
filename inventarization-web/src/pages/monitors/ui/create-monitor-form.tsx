...
import { useCreateMonitorMutation } from "@/entities/monitor";
...
const CreateMonitorForm: FC = () => {
  const [createMonitor, { isError, error }] = useCreateMonitorMutation();
...
CreateMonitorForm.displayName = "create-monitor-form";

export { CreateMonitorForm };
