...
import { useCreateGpuMutation } from "@/entities/gpu";
...
import { CreateGpuSchema } from "./../model/create-gpu-schema";

const CreateGpuForm: FC = () => {
  const [createGpu, { isError, error }] = useCreateGpuMutation();
  const { data: brands } = useGetAllBrandsQuery();

  const form = useForm({
    resolver: zodResolver(CreateGpuSchema),
    defaultValues: {
      model: "",
      manufacturerCode: "",
      brandId: "",
  ...
  const onSubmit = async (values: z.infer<typeof CreateGpuSchema>) => {
...
CreateGpuForm.displayName = "create-gpu-form";

export { CreateGpuForm };
