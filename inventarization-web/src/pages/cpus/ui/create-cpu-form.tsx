...
import { useCreateCpuMutation } from "@/entities/cpu";
...
const CreateCpuForm: FC = () => {
  const [createCpu, { isError, error }] = useCreateCpuMutation();
...
CreateCpuForm.displayName = "create-cpu-form";

export { CreateCpuForm };
